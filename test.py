...
data_path = r"/home/chenjun/code/datasets/bank_monitor/save_video/c4.mp4"
# Load a model
model = YOLO(task="detect", model='./runs/detect/train_bank_05_21_m/weights/best.pt')  # pretrained YOLOv8n model
